...
class _MenuScreenState extends State<MenuScreen> {
        ...
        slivers: [
          ...
          Consumer<RestaurantProvider>(
            builder: (context, provider, _) {
              if (provider.menuByCategory.isEmpty) return const SliverToBoxAdapter(child: SizedBox.shrink());
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            color: isActive ? AppTheme.primaryGreen : AppTheme.surfaceWhite,
                            borderRadius: BorderRadius.circular(100),
                            border: Border.all(
                              color: isActive ? AppTheme.primaryGreen : AppTheme.border.withValues(alpha: 0.5),
                            ),
                            boxShadow: isActive ? AppTheme.shadowGreen : AppTheme.shadowCard,
                          ),
                          alignment: Alignment.center,
                          child: Row(
                            mainAxisSize: MainAxisSize.min,
  ...
  Widget _buildMenuItem(MenuItem item, int index) {
                ...
                child: item.imageUrl != null
                    ? CachedNetworkImage(
                        ...
                        placeholder: (_, __) => Container(
                          ...
                          child: const Center(child: Icon(Icons.restaurant, color: AppTheme.textHint)),
                        ),
                      )
                    : Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        '₹${_getItemDisplayPrice(item).toStringAsFixed(0)}',
                        style: const TextStyle(
                          fontWeight: FontWeight.w800,
                          fontSize: 17,
                          color: AppTheme.textPrimary,
                      ...
                      if (item.sizes != null && item.sizes!.length > 1)
                        Text(
                          ' onwards',
                          style: TextStyle(
                            fontSize: 11,
                      ...
                      // Add button
                      GestureDetector(
                        onTap: () => !isUnavailable ? _addToCart(item) : null,
                        child: Container(
                          padding: const EdgeInsets.symmetric(horizontal: 22, vertical: 9),
                          decoration: BoxDecoration(
                            color: isUnavailable ? Colors.grey.shade100 : AppTheme.emerald50,
                            borderRadius: BorderRadius.circular(100),
                            border: Border.all(
                              color: isUnavailable ? Colors.grey.shade200 : AppTheme.primaryGreenLight,
                              width: 1.5,
                            ),
                          ),
                          child: Row(
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  fontSize: 13,
                                  fontWeight: FontWeight.w800,
                                  color: isUnavailable ? AppTheme.textMuted : AppTheme.primaryGreen,
                                ),
                              ),
                              if (!isUnavailable) ...[
    ...
    ).animate(delay: Duration(milliseconds: 40 * (index % 8))).fadeIn(duration: 300.ms).slideX(begin: 0.03);
  }
}
