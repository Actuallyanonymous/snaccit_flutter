                    ...
                    builder: (ctx) => AlertDialog(
                      ...
                      actions: [
                        ...
                        TextButton(
                          ...
                          child: const Text('Clear', style: TextStyle(color: AppTheme.errorRed, fontWeight: FontWeight.w700)),
                        ),
                      ],
                    ),
                  );
                        ...
                        children: [
                          ...
                          Container(
                            decoration: BoxDecoration(
                              color: AppTheme.emerald50,
                              borderRadius: BorderRadius.circular(100),
                              border: Border.all(color: AppTheme.primaryGreenLight, width: 1.5),
                            ),
                            child: Row(
                              ...
                              children: [
                                _QuantityButton(
                                  ...
                                  color: item.quantity == 1 ? AppTheme.errorRed : AppTheme.primaryGreen,
